...
class ThreeXThreeMid: UIViewController {
    ...
    @IBAction func start(_ sender: UIButton) {
        A11.text! = String(rand(min: mn, max: mxmed))
        A12.text! = String(rand(min: mn, max: mxmed))
        A13.text! = String(rand(min: mn, max: mxmed))
        A21.text! = String(rand(min: mn, max: mxmed))
        A22.text! = String(rand(min: mn, max: mxmed))
        A23.text! = String(rand(min: mn, max: mxmed))
        A31.text! = String(rand(min: mn, max: mxmed))
        A32.text! = String(rand(min: mn, max: mxmed))
        A33.text! = String(rand(min: mn, max: mxmed))
        
        B11.text! = String(rand(min: mn, max: mxmed))
        B12.text! = String(rand(min: mn, max: mxmed))
        B13.text! = String(rand(min: mn, max: mxmed))
        B21.text! = String(rand(min: mn, max: mxmed))
        B22.text! = String(rand(min: mn, max: mxmed))
        B23.text! = String(rand(min: mn, max: mxmed))
        B31.text! = String(rand(min: mn, max: mxmed))
        B32.text! = String(rand(min: mn, max: mxmed))
        B33.text! = String(rand(min: mn, max: mxmed))
